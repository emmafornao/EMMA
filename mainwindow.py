...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableView_installed.setGeometry(QtCore.QRect(5, 1, 761, 461))
        self.tableView_installed.setObjectName("tableView_installed")
        self.tableView_installed.installEventFilter(self)
        """ self.horizontalScrollBar = QtWidgets.QScrollBar(parent=self.tab_installed)
        self.horizontalScrollBar.setGeometry(QtCore.QRect(10, 460, 751, 20))
        self.horizontalScrollBar.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.horizontalScrollBar.setObjectName("horizontalScrollBar")
        self.verticalScrollBar = QtWidgets.QScrollBar(parent=self.tab_installed)
        self.verticalScrollBar.setGeometry(QtCore.QRect(770, -1, 20, 471))
        ...
        self.tableView_favourites.setGeometry(QtCore.QRect(5, 1, 761, 471))
        self.tableView_favourites.setObjectName("tableView_favourites")
        self.tableView_favourites.installEventFilter(self)
        """ self.horizontalScrollBar_2 = QtWidgets.QScrollBar(parent=self.tab_favourites)
        self.horizontalScrollBar_2.setGeometry(QtCore.QRect(10, 470, 761, 16))
        ...
        self.verticalScrollBar_2 = QtWidgets.QScrollBar(parent=self.tab_favourites)
        self.verticalScrollBar_2.setGeometry(QtCore.QRect(770, 0, 16, 471))
        ...
        self.pushButton_removeMods.setGeometry(QtCore.QRect(20, 530, 91, 23))
        ...
        self.pushButton_reinstallMods.setGeometry(QtCore.QRect(130, 530, 81, 23))
        self.pushButton_reinstallMods.setObjectName("pushButton_reinstallMods")
        """ self.pushButton_ToggleFavourite = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton_ToggleFavourite.setGeometry(QtCore.QRect(234, 530, 91, 23))
        self.pushButton_ToggleFavourite.setObjectName("pushButton_ToggleFavourite") """
        self.pushButton_clearDynamicDownloads = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton_clearDynamicDownloads.setGeometry(QtCore.QRect(350, 530, 171, 23))
